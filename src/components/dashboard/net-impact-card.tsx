    ...
    return (
        <Card className="h-full card-glass card-interactive flex flex-col overflow-hidden group bg-opacity-40">
            <CardHeader className="p-6 pb-2 relative z-10">
                <CardTitle className="text-xs font-bold uppercase tracking-[0.2em] text-white/40">Network Impact (tCO2e)</CardTitle>
            </CardHeader>
            <CardContent className="p-6 pt-2 flex-1 flex flex-col justify-between relative z-10">
                <div className="flex items-baseline gap-2 group-hover:translate-x-1 transition-transform">
                    ...
                    <Badge variant="outline" className="bg-emerald-500/10 border-emerald-500/20 text-emerald-400 text-xs h-6 px-1.5 flex items-center gap-0.5 font-bold">
                ...
                <div className="mt-6 pt-6 border-t border-white/5 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-xs font-bold text-white/20 uppercase tracking-[0.2em] leading-none mb-1.5">Ecological Status</p>

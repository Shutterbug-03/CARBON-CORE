...
export function LatestCertificateCard() {
    ...
    const initialData = {
        ...
        carbonReduced: loading ? "207.08" : carbonStats.carbonOffsetTons.toFixed(2),
        vintage: "2024",
    ...
    return (
        <Card className="w-full card-glass card-interactive flex flex-col group min-h-[500px] overflow-hidden bg-opacity-40 animate-in fade-in duration-1000">
            {/* ── Tabs Header ── */}
            <div className="flex items-center px-4 bg-white/[0.02] border-b border-white/5 relative z-20">
                <button
                    ...
                    className={cn(
                        "flex items-center gap-2 px-6 py-4 text-[10px] font-bold uppercase tracking-[0.2em] transition-all border-b-2",
            ...
            <CardContent className={cn(
                ...
                currentTab === 'certificate' ? "bg-white text-slate-900" : ""
            )}>
                ...
                <div className="flex flex-col md:flex-row justify-between gap-12 relative z-10 h-full">
                        ...
                        {currentTab === 'certificate' ? (
                            <div>
                                <div className="flex items-center gap-4 mb-10">
                                    ...
                                    <div>
                                        <p className={cn("text-[10px] font-bold uppercase tracking-[0.3em] leading-none mb-2", currentTab === 'certificate' ? "text-emerald-600/60" : "text-emerald-400")}>Verified Infrastructure Protocol</p>
                                        <p className={cn("text-[10px] font-mono tracking-tighter uppercase", currentTab === 'certificate' ? "text-slate-400" : "text-white/20")}>ID: {initialData.certificateId}</p>
                                    </div>
                                </div>

                                <h2 className={cn(
                                    "text-5xl md:text-6xl font-black tracking-tighter leading-[0.9] mb-10 group-hover:translate-x-1 transition-transform",
                                    currentTab === 'certificate' ? "text-slate-900" : "text-white"
                                )}>
                                    Digital Carbon<br />
                                ...
                                <div className="space-y-8 max-w-lg">
                                    <div className="flex items-center gap-16">
                                        <div>
                                            <p className={cn("text-[10px] font-bold uppercase tracking-[0.2em] mb-2.5", currentTab === 'certificate' ? "text-slate-400" : "text-white/20")}>Beneficiary</p>
                                            <p className={cn(
                                                "text-xl font-bold border-b pb-2 flex items-center gap-2 cursor-pointer transition-all",
                                                currentTab === 'certificate' ? "text-slate-900 border-slate-100 hover:border-emerald-500/30" : "text-white border-white/5 hover:border-emerald-500/30"
                                            )}>
                                                {initialData.recipientName}
                                                <span className={cn("text-sm", currentTab === 'certificate' ? "text-slate-300" : "text-white/10")}>▼</span>
                                            </p>
                                        </div>
                                        <div>
                                            <p className={cn("text-[10px] font-bold uppercase tracking-[0.2em] mb-2.5", currentTab === 'certificate' ? "text-slate-400" : "text-white/20")}>Asset Source</p>
                                            <p className={cn("text-xl font-bold uppercase tracking-tight transition-colors", currentTab === 'certificate' ? "text-slate-900" : "text-white group-hover:text-emerald-50")}>{initialData.projectName}</p>
                                            <p className={cn("text-[10px] font-bold uppercase tracking-widest mt-1", currentTab === 'certificate' ? "text-slate-400" : "text-white/30")}>{initialData.location}</p>
                                        </div>
                                    </div>

                                    <div className="flex items-center gap-24 pt-6">
                                        <div>
                                            <p className={cn("text-[10px] font-bold uppercase tracking-[0.2em] mb-2.5", currentTab === 'certificate' ? "text-slate-400" : "text-white/20")}>Vintage Year</p>
                                            <p className={cn("text-3xl font-black font-mono tracking-tighter", currentTab === 'certificate' ? "text-slate-900" : "text-white")}>{initialData.vintage}</p>
                                        </div>
                                        <div>
                                            <p className={cn("text-[10px] font-bold uppercase tracking-[0.2em] mb-2.5", currentTab === 'certificate' ? "text-slate-400" : "text-white/20")}>Impact Volume</p>
                                            <div className="flex items-baseline gap-2">
                                                ...
                                                <span className={cn("text-[10px] font-black uppercase tracking-[0.2em]", currentTab === 'certificate' ? "text-slate-400" : "text-white/30")}>tCO2e</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-8">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-white/30 uppercase tracking-[0.2em] font-bold">L1_ASSET_DNA_VERIFICATION</p>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="space-y-6">
                                        <div>
                                            <p className="text-[9px] font-black text-white/20 uppercase tracking-widest mb-1.5">Asset Coordinates</p>
                                            <p className="text-sm font-bold text-white font-mono">{LAT}°N, {LON}°E</p>
                                        </div>
                                        <div>
                                            <p className="text-[9px] font-black text-white/20 uppercase tracking-widest mb-1.5">System Capacity</p>
                                            <p className="text-sm font-bold text-white">{CAPACITY_MW} MW Peak (Phase IV)</p>
                                        </div>
                                        <div>
                                            <p className="text-[9px] font-black text-white/20 uppercase tracking-widest mb-1.5">Surface Area</p>
                                            <p className="text-sm font-bold text-white">250,000 m² (Photovoltaic Grid)</p>
                                        </div>
                                    </div>
                                    <div className="space-y-4">
                                        <div className="p-4 bg-white/[0.02] border border-white/5 rounded-xl">
                                            <p className="text-[9px] font-black text-white/20 uppercase tracking-widest mb-2">Technical Specs</p>
                                            <ul className="space-y-2 text-[10px] font-medium text-white/50">
                            ...
                            <div className="space-y-8">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-white/30 uppercase tracking-[0.2em] font-bold">MULTI_AGENT_CONSENSUS_LOG</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center gap-4 p-3 bg-white/[0.01] border border-white/5 rounded-xl group/log hover:bg-white/[0.03] transition-all">
                                            ...
                                            <Badge variant="outline" className="text-[8px] bg-white/5 border-white/5 text-white/40">{log.agent}</Badge>
                                            <span className="text-[11px] font-medium text-white/70 flex-1">{log.action}</span>
                                            <span className="text-[9px] font-black text-emerald-500">{log.status}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className="mt-auto pt-10 flex items-center gap-8">
                            <div className="flex items-center gap-4">
                                <div className={cn(
                                    ...
                                    currentTab === 'certificate' ? "bg-slate-100 border-slate-200 text-slate-900" : "glass-strong border-white/10 text-white"
                                )}>G</div>
                                <div>
                                    <p className={cn("text-[11px] font-bold tracking-tight leading-none mb-1.5 uppercase", currentTab === 'certificate' ? "text-slate-900" : "text-white")}>GreenPe Consensus</p>
                                    <p className={cn("text-[9px] font-bold uppercase tracking-widest", currentTab === 'certificate' ? "text-slate-400" : "text-white/30")}>Multi-Agent Sealed Signature</p>
                                </div>
                            </div>
                            <div className="ml-auto hidden md:flex items-center gap-6">
                                <div className={cn(
                                    ...
                                    <span className={cn("text-[9px] font-black uppercase tracking-[0.2em]", currentTab === 'certificate' ? "text-emerald-600" : "text-emerald-400")}>Protocol: ACTIVE</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-6 w-full md:w-[320px] shrink-0 animate-in fade-in slide-in-from-right-4 duration-1000">
                        ...
                        <Card className={cn(
                            ...
                            currentTab === 'certificate' ? "bg-slate-50 border-slate-100 shadow-sm" : "glass-strong border-white/5 bg-white/[0.02]"
                        )}>
                            <div className={cn(
                                ...
                                currentTab === 'certificate' ? "bg-white border border-slate-100" : "glass border border-white/10 bg-white"
                            )}>
                                <QrCode size={160} className="text-slate-900" />
                            </div>
                            <div className="text-center">
                                <p className={cn("text-[11px] font-black uppercase tracking-[0.2em] mb-2", currentTab === 'certificate' ? "text-slate-900" : "text-white")}>Immutable Verification</p>
                                <p className={cn("text-[10px] leading-relaxed font-medium", currentTab === 'certificate' ? "text-slate-500" : "text-white/30")}>Deterministic proof anchored to the UPI global climate ledger.</p>
                            </div>
                        </Card>
                        ...
                        <div className={cn(
                            ...
                            currentTab === 'certificate'
                                ? "bg-[#fafafa] border-slate-200 shadow-slate-200/50 hover:border-emerald-500/30 text-slate-900"
                            ...
                            <div className="flex justify-between items-center mb-6 relative z-10">
                                <Badge variant="outline" className={cn(
                                    "text-[9px] font-black tracking-[0.2em] px-3 py-0.5",
                            ...
                            <div className="flex justify-between items-end mb-6 relative z-10">
                                <div>
                                    <p className={cn("text-3xl font-black font-mono tracking-tighter", currentTab === 'certificate' ? "text-slate-900" : "text-white")}>
                                        {loading ? "0.00" : solarData?.current.ghi ?? "0.00"} <span className="text-[10px] text-emerald-500 font-bold ml-1 uppercase">W/m²</span>
                                    </p>
                                    <div className="flex items-center gap-2 mt-1">
                                        <p className={cn("text-[9px] font-black uppercase tracking-[0.2em]", currentTab === 'certificate' ? "text-slate-400" : "text-white/20")}>Real-time Irradiance</p>
                                        {currentTab !== 'certificate' && (
                            ...
                            <Button
                                className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-black text-[11px] uppercase h-11 tracking-[0.2em] rounded-xl shadow-xl shadow-emerald-900/20 active:scale-95 transition-all relative z-10 border-0"
                                asChild
                            >
                            ...
                            <div className="mt-4 flex items-center justify-center gap-2 relative z-10">
                                <span className={cn("text-[9px] font-bold uppercase tracking-[0.3em]", currentTab === 'certificate' ? "text-slate-300" : "text-white/10")}>Last Synced {new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} UTC</span>
                            </div>
                        </div>
                    </div>

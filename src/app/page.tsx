        ...
        <nav className={`mx-auto transition-all duration-700 ${
          ...
          <div className="flex items-center justify-between gap-8">
            ...
            <div className="hidden md:flex items-center gap-6">
              <a href="#problem" className={`font-bold transition-all duration-700 ${isScrolled ? "text-[13px] text-foreground/70 hover:text-foreground" : "text-sm text-foreground/80 hover:text-foreground"}`}>The Problem</a>
              <a href="#how-it-works" className={`font-bold transition-all duration-700 ${isScrolled ? "text-[13px] text-foreground/70 hover:text-foreground" : "text-sm text-foreground/80 hover:text-foreground"}`}>How It Works</a>
